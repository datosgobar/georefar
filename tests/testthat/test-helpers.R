...
test_that("httr2_error_handler genera mensaje con status y URL", {
  ...
  stub(httr2_error_handler, "httr2::resp_status",      function(r) 404)
  stub(httr2_error_handler, "httr2::resp_status_desc", function(r) "Not Found")
  stub(httr2_error_handler, "httr2::resp_url",         function(r) "https://apis.datos.gob.ar/georef/api/v2.0/provincias")
  stub(httr2_error_handler, "httr2::resp_has_body",    function(r) FALSE)
