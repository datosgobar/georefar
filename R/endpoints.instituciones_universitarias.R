#' Obtener Instituciones Universitarias
#'
#' Permite realizar búsquedas sobre el listado de instituciones universitarias.
#' Realiza la consulta GET al endpoint /instituciones-universitarias de georef-ar-api.
...
#'
#' @export
#' @rdname get_instituciones_universitarias
#'
